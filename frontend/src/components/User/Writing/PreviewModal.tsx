  ...
  return (
    <div>
      <div
        ...
        className="hs-overlay w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto bg-gray-300"
      >
        <div
          ref={ref}
              ...
              <div className="space-y-4">
                ...
                <div className="card m-2  border-gray-400 rounded-lg hover:shadow-md hover:border-opacity-0 transform hover:-translate-y-1 transition-all duration-200">
                  <div className="m-3">
                    ...
                    <div className="flex justify-center">카드 컴포넌트</div>
                  </div>
                </div>
