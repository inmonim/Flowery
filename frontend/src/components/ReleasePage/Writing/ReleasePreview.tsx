          ...
          <div ref={ref} className="bg-white ">
            {!clickQR ? (
              <div className="w-full relative">
                <div className="h-screen animate-fadeOut animation-delay-2000">
                  <ReleaseCard />
                </div>
                <p className="absolute text-sm text-center text-[#FEF7F1] top-[20%] mx-auto animate-fadeIn animation-delay-4000">
                  카드의 qr을 찍었을 때의 미리보기입니다!
                </p>
                <img
                  src={`data:image/png;base64,${testQr}`}
                  alt="qr"
                  onClick={() => setClickQR(true)}
                  className="absolute top-[15%] left-[500px] w-[100px] cursor-pointer animate-slider animation-delay-4000"
                />
              </div>
            ) : (
              <div>
